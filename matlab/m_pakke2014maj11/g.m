function [d,lump] = g(m,fixed_stuff)
...
%       problem if d18O_triang == d18Oth at one or more samples.
      i_t_trunc = find(ti*1e6>20e3);
      tExtract = ti(i_t_trunc)*1e6;
      [tStarts,relExpos] = ExtractHistory2(tExtract,d18O_triang(i_t_trunc),d18Oth,ErateInt,ErateGla); %should fix the ys=midvalue problem
