...
addpath('..\UdviklingFeb2014\m\m_pakke2014mar25')
addpath('..\UdviklingFeb2014\m\m_pakke2014maj11\')
clear; close all
[fn,pn]=uigetfile('*.mat')
load([pn,fn])
...
dXxfine = 0.01; Xxfinemax = 400; iz=1; %Xx may be depth or nucleide concentration or ...
...
%Fig7_rev_Z_all = [-tsfine',quants2(1,:,iwalk)',quants2(2,:,iwalk)',quants2(3,:,iwalk)'];
%save Fig7_rev_Z_all Fig7_rev_Z_all -ascii

%Fig7_rev_Z0_Be_Al = [-tsfine',quants2(1,:,iwalk)',quants2(2,:,iwalk)',quants2(3,:,iwalk)'];
%save Fig7_rev_Z0_Be_Al Fig7_rev_Z0_Be_Al -ascii

%Plot figure comparing different sampling strategies
%figure;
%hold on
%lh2(1)=plot(-tsfine,quants2(1,:,iwalk),'r','linewidth',0.7)
%lh2(2)=plot(-tsfine,quants2(2,:,iwalk),'k','linewidth',2)
%lh2(3)=plot(-tsfine,quants2(3,:,iwalk),'r','linewidth',0.7)
%%legend(lh2,'25%','median','75%','location','northwest')
%axis ij

%load Fig7_rev_Z_all
%load Fig7_rev_Z0_Be_Al
%plot(Fig7_rev_Z_all(:,1),Fig7_rev_Z_all(:,2),'b','linewidth',0.7);
%plot(Fig7_rev_Z_all(:,1),Fig7_rev_Z_all(:,3),'b','linewidth',2);
%plot(Fig7_rev_Z_all(:,1),Fig7_rev_Z_all(:,4),'b','linewidth',0.7);

%plot(Fig7_rev_Z0_Be_Al(:,1),Fig7_rev_Z0_Be_Al(:,2),'g','linewidth',0.7);
%plot(Fig7_rev_Z0_Be_Al(:,1),Fig7_rev_Z0_Be_Al(:,3),'g','linewidth',2);
%plot(Fig7_rev_Z0_Be_Al(:,1),Fig7_rev_Z0_Be_Al(:,4),'g','linewidth',0.7);
